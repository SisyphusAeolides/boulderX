...
/// Append an Element X-style message bubble row to the TextView.
/// Renders: timestamp · nick · body, with per-nick color.
...
/// Clear the view and re-render a full history slice.
pub fn render_history(
    view: &gtk::TextView,
    lines: &[(String, String, String, LineStyle)], // (ts, user, body, style)
    nick_colors_enabled: bool,
) {
